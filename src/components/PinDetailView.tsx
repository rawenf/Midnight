...
export default function PinDetailView({ pin, allPins, onBack, onPinClick, onSearch, onDelete, onProfileClick }: PinDetailViewProps) {
  ...
  const handleDownload = async () => {
    try {
      ...
      // SECURITY: Sanitize pin.imageUrl to prevent javascript: URI XSS if opened in new tab
            ...
            {isEditing ? (
              ...
              <>
                ...
                <div className="space-y-4">
                  ...
                  {/* SECURITY: Sanitize pin.source to prevent Stored XSS via javascript: URI */}
                  <a 
