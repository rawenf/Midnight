...
export default function PinDetailView({ pin, allPins, onBack, onPinClick, onSearch, onDelete, onProfileClick }: PinDetailViewProps) {
  ...
  const handleDownload = async () => {
    try {
      ...
      // SECURITY: Sanitize user-provided URL before opening to prevent XSS
      window.open(getSafeUrl(pin.imageUrl, 'about:blank'), '_blank');
    }
  };
            ...
            {isEditing ? (
              ...
              <>
                ...
                <div className="space-y-4">
                  ...
                  {/* SECURITY: Sanitize href to prevent javascript: URI XSS */}
                  <a 
