...
export default function App() {
  ...
  // Performance optimization: Memoize computationally expensive array operations
  // This prevents O(N) filtering and O(N log N) sorting on every render (e.g. during modal toggles)
