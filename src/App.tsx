...
export default function App() {
  ...
  // Performance Optimization: Memoize array operations to prevent main thread blocking during frequent re-renders
  // Impact: Reduces CPU time for filtering/sorting by caching results when dependencies haven't changed
