...
export default function App() {
  ...
  // Performance optimization: Memoize expensive array operations to prevent
  // blocking the main thread during frequent re-renders (like scrolling or modal toggling).
