...
export default function App() {
  ...
  // ⚡ Bolt: Memoize derived pin arrays to prevent recalculation on every render
  ...
  // ⚡ Bolt: Memoize expensive filtering and sorting operations to prevent
  // blocking the main thread on unrelated re-renders (like modal toggles)
