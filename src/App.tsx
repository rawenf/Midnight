...
export default function App() {
  ...
  // ⚡ Bolt: Memoize expensive array operations to prevent blocking the main thread during frequent re-renders
  ...
  // ⚡ Bolt: Memoize complex filtering and sorting logic
