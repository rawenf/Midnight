...
export default function App() {
  ...
  // ⚡ Bolt Optimization: Memoize expensive array filters to avoid re-calculating on every render
  ...
  // ⚡ Bolt Optimization: Memoize the heavy sort and filter pipeline for main feed
