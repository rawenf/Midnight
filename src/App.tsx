...
export default function App() {
  ...
  // ⚡ Bolt Optimization: Memoize expensive synchronous array operations to prevent
  // main thread blocking and unnecessary recalculations during frequent re-renders.
