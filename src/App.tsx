...
export default function App() {
  ...
  // Performance Optimization: Memoize expensive array filters to avoid re-calculation on every render
  ...
  // Performance Optimization: Memoize the primary search/filter/sort pipeline
