...
export default function App() {
  ...
  // Performance Impact: Memoizing these expensive array operations prevents unnecessary
  // main thread blocking during frequent component re-renders (e.g. typing in search, toggling modals).
